...
const AuctionUploadPage = () => {
  ...
  useEffect(() => {
    if (createAuctionError) {
      alert('Auction registration failed.');
    }
  }, [createAuctionError]);
        ...
        <>
          ...
          {!loading ? (
            ...
            <>
              ...
              <AuctionButton text="Go to main auction" link={'nft/auction'} />
            </>
          ) : (
            <>There are currently no NFTs available for sale!</>
          )}
        </>
      ) : (
        <>
