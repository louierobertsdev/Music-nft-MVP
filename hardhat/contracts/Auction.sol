...
contract Auction{
    ...
    uint256 public startAt; // Auction start time
    uint256 public endAt;   // end time
    uint256 public tokenID;    // Token ID
    uint256 public highestBindingBid; // highest price
    address payable public highestBidder; // The highest posted owner
    uint256 public minimumBid; // minimum bid
