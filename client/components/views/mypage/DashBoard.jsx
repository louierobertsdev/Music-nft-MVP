    ...
    <>
      <Section>
        ...
        <div className="analytic">
          ...
          <div className="content">
            <h3>Number of favorite song tracks</h3>
      ...
      <Box sx={{ color: '#fff', marginTop: '40px' }}>
        ...
        >
          <h1>My latest registered music list</h1>
        </Box>
      ...
      <Box sx={{ color: '#fff' }}>
        {studio.studioMyMusics ? <MyRecentMusic /> : <Box>Doesn't exist</Box>}
      </Box>
    </>
  );
};
